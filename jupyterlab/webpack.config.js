...
JupyterLabPlugin.prototype.apply = function(compiler) {
  ...
  compiler.plugin('compilation', function(compilation) {
    ...
    // At the emit stage, override the assets with our own list of modules
    // And generate our own CSS bundle.
    compiler.plugin("emit", function(compilation, callback) {
      ...
      compilation.chunks.forEach(function(chunk) {
        ...
        chunk.modules.forEach(function(module) {
          // Build up our chunk here
            // TODO: look for css here and extract it
            if (module.userRequest && path.extname(module.userRequest) === '.css') {
              debugger;
            }
        });
