...
return {_pyfunc_op_mult: _pyfunc_op_mult, _pyfunc_any: _pyfunc_any, _pyfunc_getattr: _pyfunc_getattr, _pyfunc_all: _pyfunc_all, _pyfunc_sorted: _pyfunc_sorted, _pyfunc_time: _pyfunc_time, _pyfunc_hasattr: _pyfunc_hasattr, _pyfunc_repr: _pyfunc_repr, _pyfunc_int: _pyfunc_int, _pyfunc_op_equals: _pyfunc_op_equals, _pyfunc_range: _pyfunc_range, _pyfunc_filter: _pyfunc_filter, _pyfunc_op_add: _pyfunc_op_add, _pyfunc_enumerate: _pyfunc_enumerate, _pyfunc_perf_counter: _pyfunc_perf_counter, _pyfunc_list: _pyfunc_list, _pyfunc_bool: _pyfunc_bool, _pyfunc_abs: _pyfunc_abs, _pyfunc_setattr: _pyfunc_setattr, _pyfunc_float: _pyfunc_float, _pyfunc_str: _pyfunc_str, _pyfunc_pow: _pyfunc_pow, _pyfunc_sum: _pyfunc_sum, _pyfunc_map: _pyfunc_map, _pyfunc_round: _pyfunc_round, _pyfunc_reversed: _pyfunc_reversed, _pyfunc_truthy: _pyfunc_truthy, _pyfunc_op_contains: _pyfunc_op_contains, _pyfunc_divmod: _pyfunc_divmod, _pyfunc_zip: _pyfunc_zip, _pyfunc_dict: _pyfunc_dict, _pyfunc_op_instantiate: _pyfunc_op_instantiate, _pyfunc_delattr: _pyfunc_delattr, _pymeth_sort: _pymeth_sort, _pymeth_isidentifier: _pymeth_isidentifier, _pymeth_isalpha: _pymeth_isalpha, _pymeth_rsplit: _pymeth_rsplit, _pymeth_setdefault: _pymeth_setdefault, _pymeth_index: _pymeth_index, _pymeth_strip: _pymeth_strip, _pymeth_keys: _pymeth_keys, _pymeth_values: _pymeth_values, _pymeth_istitle: _pymeth_istitle, _pymeth_update: _pymeth_update, _pymeth_partition: _pymeth_partition, _pymeth_startswith: _pymeth_startswith, _pymeth_pop: _pymeth_pop, _pymeth_split: _pymeth_split, _pymeth_items: _pymeth_items, _pymeth_endswith: _pymeth_endswith, _pymeth_copy: _pymeth_copy, _pymeth_isupper: _pymeth_isupper, _pymeth_popitem: _pymeth_popitem, _pymeth_ljust: _pymeth_ljust, _pymeth_isalnum: _pymeth_isalnum, _pymeth_rpartition: _pymeth_rpartition, _pymeth_join: _pymeth_join, _pymeth_repeat: _pymeth_repeat, _pymeth_get: _pymeth_get, _pymeth_splitlines: _pymeth_splitlines, _pymeth_swapcase: _pymeth_swapcase, _pymeth_rstrip: _pymeth_rstrip, _pymeth_reverse: _pymeth_reverse, _pymeth_isnumeric: _pymeth_isnumeric, _pymeth_isspace: _pymeth_isspace, _pymeth_zfill: _pymeth_zfill, _pymeth_find: _pymeth_find, _pymeth_remove: _pymeth_remove, _pymeth_replace: _pymeth_replace, _pymeth_title: _pymeth_title, _pymeth_extend: _pymeth_extend, _pymeth_rjust: _pymeth_rjust, _pymeth_casefold: _pymeth_casefold, _pymeth_upper: _pymeth_upper, _pymeth_clear: _pymeth_clear, _pymeth_append: _pymeth_append, _pymeth_insert: _pymeth_insert, _pymeth_islower: _pymeth_islower, _pymeth_center: _pymeth_center, _pymeth_count: _pymeth_count, _pymeth_rindex: _pymeth_rindex, _pymeth_expandtabs: _pymeth_expandtabs, _pymeth_lower: _pymeth_lower, _pymeth_lstrip: _pymeth_lstrip, _pymeth_translate: _pymeth_translate, _pymeth_capitalize: _pymeth_capitalize, _pymeth_rfind: _pymeth_rfind};
});
...
var _pyfunc_op_mult = _py._pyfunc_op_mult, _pyfunc_any = _py._pyfunc_any, _pyfunc_getattr = _py._pyfunc_getattr, _pyfunc_all = _py._pyfunc_all, _pyfunc_sorted = _py._pyfunc_sorted, _pyfunc_time = _py._pyfunc_time, _pyfunc_hasattr = _py._pyfunc_hasattr, _pyfunc_repr = _py._pyfunc_repr, _pyfunc_int = _py._pyfunc_int, _pyfunc_op_equals = _py._pyfunc_op_equals, _pyfunc_range = _py._pyfunc_range, _pyfunc_filter = _py._pyfunc_filter, _pyfunc_op_add = _py._pyfunc_op_add, _pyfunc_enumerate = _py._pyfunc_enumerate, _pyfunc_perf_counter = _py._pyfunc_perf_counter, _pyfunc_list = _py._pyfunc_list, _pyfunc_bool = _py._pyfunc_bool, _pyfunc_abs = _py._pyfunc_abs, _pyfunc_setattr = _py._pyfunc_setattr, _pyfunc_float = _py._pyfunc_float, _pyfunc_str = _py._pyfunc_str, _pyfunc_pow = _py._pyfunc_pow, _pyfunc_sum = _py._pyfunc_sum, _pyfunc_map = _py._pyfunc_map, _pyfunc_round = _py._pyfunc_round, _pyfunc_reversed = _py._pyfunc_reversed, _pyfunc_truthy = _py._pyfunc_truthy, _pyfunc_op_contains = _py._pyfunc_op_contains, _pyfunc_divmod = _py._pyfunc_divmod, _pyfunc_zip = _py._pyfunc_zip, _pyfunc_dict = _py._pyfunc_dict, _pyfunc_op_instantiate = _py._pyfunc_op_instantiate, _pyfunc_delattr = _py._pyfunc_delattr;
var _pymeth_sort = _py._pymeth_sort, _pymeth_isidentifier = _py._pymeth_isidentifier, _pymeth_isalpha = _py._pymeth_isalpha, _pymeth_rsplit = _py._pymeth_rsplit, _pymeth_setdefault = _py._pymeth_setdefault, _pymeth_index = _py._pymeth_index, _pymeth_strip = _py._pymeth_strip, _pymeth_keys = _py._pymeth_keys, _pymeth_values = _py._pymeth_values, _pymeth_istitle = _py._pymeth_istitle, _pymeth_update = _py._pymeth_update, _pymeth_partition = _py._pymeth_partition, _pymeth_startswith = _py._pymeth_startswith, _pymeth_pop = _py._pymeth_pop, _pymeth_split = _py._pymeth_split, _pymeth_items = _py._pymeth_items, _pymeth_endswith = _py._pymeth_endswith, _pymeth_copy = _py._pymeth_copy, _pymeth_isupper = _py._pymeth_isupper, _pymeth_popitem = _py._pymeth_popitem, _pymeth_ljust = _py._pymeth_ljust, _pymeth_isalnum = _py._pymeth_isalnum, _pymeth_rpartition = _py._pymeth_rpartition, _pymeth_join = _py._pymeth_join, _pymeth_repeat = _py._pymeth_repeat, _pymeth_get = _py._pymeth_get, _pymeth_splitlines = _py._pymeth_splitlines, _pymeth_swapcase = _py._pymeth_swapcase, _pymeth_rstrip = _py._pymeth_rstrip, _pymeth_reverse = _py._pymeth_reverse, _pymeth_isnumeric = _py._pymeth_isnumeric, _pymeth_isspace = _py._pymeth_isspace, _pymeth_zfill = _py._pymeth_zfill, _pymeth_find = _py._pymeth_find, _pymeth_remove = _py._pymeth_remove, _pymeth_replace = _py._pymeth_replace, _pymeth_title = _py._pymeth_title, _pymeth_extend = _py._pymeth_extend, _pymeth_rjust = _py._pymeth_rjust, _pymeth_casefold = _py._pymeth_casefold, _pymeth_upper = _py._pymeth_upper, _pymeth_clear = _py._pymeth_clear, _pymeth_append = _py._pymeth_append, _pymeth_insert = _py._pymeth_insert, _pymeth_islower = _py._pymeth_islower, _pymeth_center = _py._pymeth_center, _pymeth_count = _py._pymeth_count, _pymeth_rindex = _py._pymeth_rindex, _pymeth_expandtabs = _py._pymeth_expandtabs, _pymeth_lower = _py._pymeth_lower, _pymeth_lstrip = _py._pymeth_lstrip, _pymeth_translate = _py._pymeth_translate, _pymeth_capitalize = _py._pymeth_capitalize, _pymeth_rfind = _py._pymeth_rfind;
...
Flexx.Ƥ.initSocket = function () {
    var WebSocket, address, err_3, err_4, on_ws_close, on_ws_error, on_ws_message, on_ws_open, ws;
    ...
    if ((!_pyfunc_truthy(this.ws_url))) {
        ...
        this.ws_url = "ws://" + address + "/flexx/ws/" + this.app_name + "";
    }
    ...
    on_ws_close = (function (evt) {
        ...
        if (_pyfunc_truthy(((!_pyfunc_truthy(this.is_notebook))) && ((!_pyfunc_truthy(this.nodejs))))) {
...
flexx.classes.HasEvents.Ƥ.__create_Handler = function (handler_func, name, connection_strings) {
    ...
    handler._seek_event_object = function (index, path, ob) {
        ...
        if ((_pyfunc_op_contains(selector, "***") && ((({}).toString.call(ob).match(/\s([a-zA-Z]+)/)[1].toLowerCase() === 'array')))) {
            ...
            err_3 = new Error('RuntimeError:' + (_pymeth_replace.call(_pymeth_replace.call(t, "{opname_full}", obname_full), "{opname}", obname))); err_3.name = "RuntimeError"; throw err_3;
        } else {
