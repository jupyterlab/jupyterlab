...
test.describe('Benchmark', () => {
  ...
  test.beforeAll(async ({ baseURL, browser, tmpPath, waitForApplication }) => {
    ...
    page = await galata.newPage(browser, baseURL, waitForApplication);
    // If some unsaved documents are opened, a browser dialog will pop-up
