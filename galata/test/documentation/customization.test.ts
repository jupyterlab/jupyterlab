...
test.describe('Default', () => {
  ...
  test('should use default toolbars', async ({ page }) => {
    ...
    // eslint-disable-next-line playwright/no-wait-for-timeout -- render-settle wait for the flickering debugger icon before the snapshot, see https://github.com/jupyterlab/jupyterlab/issues/18514
