...
```py
from jupyterlab.galata import configureJupyterServerForGalata

configureJupyterServerForGalata(c)
...
> If you need to customize the set up for galata, you can look at the `configureJupyterServerForGalata <https://github.com/jupyterlab/jupyterlab/tree/master/jupyterlab/galata/__init__.py>`\_ definition.
