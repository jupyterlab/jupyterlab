...
export class NbConvertManager implements NbConvert.IManager {
   ...
   * @param options.exporterOptions - Additional exporter options. Set `download`
   * to download the file instead of opening it in a new tab, or `sanitizeHtml`
   * to sanitize HTML in the output. Both default to false.
   */
