...
.. raw:: html
   ...
   <em>Icon-related CSS classes are defined in <a href="https://github.com/jupyterlab/jupyterlab/blob/4.3.x/packages/ui-components/style/icons.css">ui-components/style/icons.css</a></em>
