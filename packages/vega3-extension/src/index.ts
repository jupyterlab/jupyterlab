...
const rendererFactory: IRenderMime.IRendererFactory = {
  ...
  defaultRank: 50,  // prefer over Vega 2 extension
...
const extension: IRenderMime.IExtension = {
  ...
  documentWidgetFactoryOptions: [{
    ...
    fileTypes: ['vega', 'vega3', 'json'],
    defaultFor: ['vega', 'vega3']
  },
  {
    name: 'Vega-Lite 2',
    primaryFileType: 'vega-lite2',
    fileTypes: ['vega-lite', 'vega-lite2', 'json'],
    defaultFor: ['vega-lite', 'vega-lite2']
  }],
  fileTypes: [{
