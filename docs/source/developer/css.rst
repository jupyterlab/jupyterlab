...
`packages/theme-light-extension/style/variables.css <https://github.com/jupyterlab/jupyterlab/blob/4.4.x/packages/theme-light-extension/style/variables.css>`_.
