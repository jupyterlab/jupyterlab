...
If you see a test run fail with ``Library not loaded: '@rpath/libpixman-1.0.dylib'`` (or different library, for example ``libcairo.2.dylib`` for Mac computers with Apple silicon) while running the
