...
`dev_mode/package.json <https://github.com/jupyterlab/jupyterlab/blob/4.3.x/dev_mode/package.json>`__.
...
`Galata <https://github.com/jupyterlab/jupyterlab/tree/4.3.x/galata>`__ is used for UI
