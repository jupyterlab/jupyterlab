...
* Fix Css Include Files (`#6541 <https://github.com/jupyterlab/jupyterlab/pull/6541>`__)
* Css Usage Cleanup (`#6533 <https://github.com/jupyterlab/jupyterlab/pull/6533>`__, `#6530 <https://github.com/jupyterlab/jupyterlab/issues/6530>`__)
* Remove Bottom Border For Tabbar. (`#6526 <https://github.com/jupyterlab/jupyterlab/pull/6526>`__, `#6521 <https://github.com/jupyterlab/jupyterlab/issues/6521>`__)
...
* Remove `dialog.prompt` (Use `inputdialog.getxxx` Instead) (`#6522 <https://github.com/jupyterlab/jupyterlab/pull/6522>`__, `#6378 <https://github.com/jupyterlab/jupyterlab/issues/6378>`__)
* Examples For Vdom/vdom-Extension (`#6519 <https://github.com/jupyterlab/jupyterlab/pull/6519>`__)
* Lazy Load Of Vim Mode (`#6516 <https://github.com/jupyterlab/jupyterlab/pull/6516>`__)
* Don't Append Content In Rendered Output Upon Rerendering. (`#6513 <https://github.com/jupyterlab/jupyterlab/pull/6513>`__, `#6505 <https://github.com/jupyterlab/jupyterlab/issues/6505>`__, `#6497 <https://github.com/jupyterlab/jupyterlab/issues/6497>`__)
...
* Only Write To Filebrowser Listing Text If The Text Would Change (`#6502 <https://github.com/jupyterlab/jupyterlab/pull/6502>`__, `#5996 <https://github.com/jupyterlab/jupyterlab/issues/5996>`__)
* Disable Chunkssort In Htmlwebpackplugin (`#6500 <https://github.com/jupyterlab/jupyterlab/pull/6500>`__)
* Rename "inspector" To "interactive Help" (`#6493 <https://github.com/jupyterlab/jupyterlab/pull/6493>`__, `#6488 <https://github.com/jupyterlab/jupyterlab/issues/6488>`__)
* Css: Remove 'overflow: Visible' Property From '.p-Dockpanel-Tabbar' Class. (`#6492 <https://github.com/jupyterlab/jupyterlab/pull/6492>`__, `#3986 <https://github.com/jupyterlab/jupyterlab/issues/3986>`__)
* Add Documentation To The Keyboard Shortcuts Component In The Advanced Settings Editor To Explain How To Disable System Default Shortcuts. (`#6490 <https://github.com/jupyterlab/jupyterlab/pull/6490>`__, `#6249 <https://github.com/jupyterlab/jupyterlab/issues/6249>`__)
* Made Non-Breaking Space Change (`#6489 <https://github.com/jupyterlab/jupyterlab/pull/6489>`__)
* Change Keyboard Shortcut For 'close Tab' To 'alt+w' From 'accel+w'. (`#6486 <https://github.com/jupyterlab/jupyterlab/pull/6486>`__, `#6357 <https://github.com/jupyterlab/jupyterlab/issues/6357>`__)
* Rename 'close Other Tabs' Command Item To 'close All Other Tabs'. (`#6485 <https://github.com/jupyterlab/jupyterlab/pull/6485>`__)
* Stop Using Py35 On Linux (`#6484 <https://github.com/jupyterlab/jupyterlab/pull/6484>`__)
* Do Not Wait For A Console Session To Be Ready Before Showing The Console (`#6480 <https://github.com/jupyterlab/jupyterlab/pull/6480>`__, `#6457 <https://github.com/jupyterlab/jupyterlab/issues/6457>`__)
* Added Default Text To Inspector Module (`#6476 <https://github.com/jupyterlab/jupyterlab/pull/6476>`__)
...
* Remove Obsolete Documentation On "keymap" Interface (`#6470 <https://github.com/jupyterlab/jupyterlab/pull/6470>`__)
* Svg Namespace. Fixes #6295. (`#6469 <https://github.com/jupyterlab/jupyterlab/pull/6469>`__, `#6295 <https://github.com/jupyterlab/jupyterlab/issues/6295>`__)
* Stop Endless Firefox Redirect. (`#6468 <https://github.com/jupyterlab/jupyterlab/pull/6468>`__, `#6408 <https://github.com/jupyterlab/jupyterlab/issues/6408>`__)
* Terminal Opens On Place. Fixes #6455. (`#6467 <https://github.com/jupyterlab/jupyterlab/pull/6467>`__)
* No More Keypress/keydown Confusion (No More Keypress). Fixes #6452. (`#6466 <https://github.com/jupyterlab/jupyterlab/pull/6466>`__, `#6452 <https://github.com/jupyterlab/jupyterlab/issues/6452>`__)
* Fix Minor Typo In Documentation (`#6464 <https://github.com/jupyterlab/jupyterlab/pull/6464>`__)
* More Release Cleanup (`#6462 <https://github.com/jupyterlab/jupyterlab/pull/6462>`__)
* Update Phosphor Packages To Restore Tab Drop Zone (`#6454 <https://github.com/jupyterlab/jupyterlab/pull/6454>`__, `#5406 <https://github.com/jupyterlab/jupyterlab/issues/5406>`__)
* Jupyterhub Integration (`#6451 <https://github.com/jupyterlab/jupyterlab/pull/6451>`__, `#6428 <https://github.com/jupyterlab/jupyterlab/issues/6428>`__)
* More Examples Test Cleanup (`#6450 <https://github.com/jupyterlab/jupyterlab/pull/6450>`__)
* Audit Keyboard Shortcuts For Accel Instead Of Ctrl (`#6447 <https://github.com/jupyterlab/jupyterlab/pull/6447>`__, `#5023 <https://github.com/jupyterlab/jupyterlab/issues/5023>`__)
* Release Cleanup (`#6445 <https://github.com/jupyterlab/jupyterlab/pull/6445>`__, `#6435 <https://github.com/jupyterlab/jupyterlab/issues/6435>`__, `#6431 <https://github.com/jupyterlab/jupyterlab/issues/6431>`__)
* Modified Markdown Cells' Overflow To "auto" (`#6444 <https://github.com/jupyterlab/jupyterlab/pull/6444>`__)
* Upgrade To Typescript 3.5.1 (`#6440 <https://github.com/jupyterlab/jupyterlab/pull/6440>`__)
* Update Changelog To Reflect 1.0a5 Release, The Good Release. (`#6438 <https://github.com/jupyterlab/jupyterlab/pull/6438>`__)
* Prepublishonly Integrity Check (`#6437 <https://github.com/jupyterlab/jupyterlab/pull/6437>`__)
* Make Kernel Message Typings More Correct (`#6433 <https://github.com/jupyterlab/jupyterlab/pull/6433>`__)
* Very Rough Changelog For The Next Alpha, Alpha 4. (`#6430 <https://github.com/jupyterlab/jupyterlab/pull/6430>`__)
...
* Fix App Example (`#6414 <https://github.com/jupyterlab/jupyterlab/pull/6414>`__, `#6413 <https://github.com/jupyterlab/jupyterlab/issues/6413>`__)
...
* Css Import Refactor (`#6395 <https://github.com/jupyterlab/jupyterlab/pull/6395>`__, `#6390 <https://github.com/jupyterlab/jupyterlab/issues/6390>`__)
...
*  Add Jp-Icon And Jp-Icon-16 Classnames To Toolbarbuttons With Icons (`#6049 <https://github.com/jupyterlab/jupyterlab/pull/6049>`__, `#5971 <https://github.com/jupyterlab/jupyterlab/issues/5971>`__)
* Fix Typo (`#6047 <https://github.com/jupyterlab/jupyterlab/pull/6047>`__, `#6046 <https://github.com/jupyterlab/jupyterlab/issues/6046>`__)
...
* Add "render All Markdown Cells" Command (`#6029 <https://github.com/jupyterlab/jupyterlab/pull/6029>`__, `#6017 <https://github.com/jupyterlab/jupyterlab/issues/6017>`__)
