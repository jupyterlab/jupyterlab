...
- ``@jupyterlab/docprovider`` from 3.x to 4.x
   ...
   `RTC's documentation <https://jupyterlab.readthedocs.io/en/4.3.x/user/rtc.html>`_
...
`JupyterLab core packages code base <https://github.com/jupyterlab/jupyterlab/tree/4.3.x/packages>`__
...
.. note::
  ...
  ``@jupyterlab/services``,
  `consult the repository <https://github.com/jupyterlab/jupyterlab/tree/4.3.x/packages/services#readme>`__.
...
.. note::
  ...
  `consult the repository <https://github.com/jupyterlab/jupyterlab/tree/4.3.x/packages/ui-components#readme>`__.
