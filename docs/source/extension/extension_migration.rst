...
`JupyterLab core packages code base <https://github.com/jupyterlab/jupyterlab/tree/4.4.x/packages>`__
...
.. note::
  ...
  ``@jupyterlab/services``,
  `consult the repository <https://github.com/jupyterlab/jupyterlab/tree/4.4.x/packages/services#readme>`__.
...
.. note::
  ...
  `consult the repository <https://github.com/jupyterlab/jupyterlab/tree/4.4.x/packages/ui-components#readme>`__.
