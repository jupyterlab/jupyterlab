...
3. Wraps all translatable strings with one of the `gettext functions <https://jupyterlab.readthedocs.io/en/4.3.x/api/modules/translation.html#translationbundle>`_.
