...
large umbrella project centered around the goal of providing tools (and `standards <https://docs.jupyter.org/en/stable/#sub-project-documentation`_) for interactive
