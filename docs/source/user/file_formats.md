...
Virtual DOM libraries such as [react.js](https://reactjs.org/) have
...
format](https://github.com/nteract/vdom) for virtual DOM data.
...
The [nteract/vdom](https://github.com/nteract/vdom) library provides
