...
the results are listed according to the [registry's sort order](https://docs.npmjs.com/searching-for-and-choosing-packages-to-download#package-search-rank-criteria).
...
on [this page](https://2.python-requests.org/en/v2.7.0/api/#requests.request)
