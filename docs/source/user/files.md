...
## File creation behavior with multiple drives

JupyterLab can be configured with multiple drives, which may be provided by the server
or by extensions.
...
Extensions may register custom drives to support additional storage backends.
